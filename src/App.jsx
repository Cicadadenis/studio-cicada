...
function validateDSL(code, stacks, blockTypes = BLOCK_TYPES) {
  const errors = [];
  const warnings = [];
            ...
            {showExamples && (
              <>
                ...
                <div style={{
                  ...
                  {[['echo', builderUi.examplesEcho],['shop', builderUi.examplesShop],['full', builderUi.examplesFull]].map(([key,label],i,arr) => (
                    <button key={key}
