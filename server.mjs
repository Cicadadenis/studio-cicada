...
СЦЕНАРИЙ И НЕСКОЛЬКО ВОПРОСОВ:
  Простая форма после кнопки/команды может быть линейной прямо в обработчике: callback→ask→ask→condition→message→else→message→stop.
  Длинный многошаговый опрос или переиспользуемый процесс делай через scenario+step:
...
4. Разрешено несколько ask подряд в одном обработчике для простой формы (например логин+пароль). Для длинных сценариев используй step между ask.
...
const FEW_SHOT_ASSISTANT_4 = `[{"id":"s0","x":40,"y":40,"blocks":[{"id":"b0","type":"bot","props":{"token":"YOUR_BOT_TOKEN"}}]},{"id":"s1","x":400,"y":40,"blocks":[{"id":"b1","type":"start","props":{}},{"id":"b2","type":"message","props":{"text":"Добро пожаловать! Пожалуйста, авторизируйтесь."}},{"id":"b3","type":"buttons","props":{"rows":"Авторизация"}},{"id":"b4","type":"stop","props":{}}]},{"id":"s2","x":760,"y":40,"blocks":[{"id":"b5","type":"callback","props":{"label":"Авторизация"}},{"id":"b6","type":"ask","props":{"question":"Введите ваш логин:","varname":"логин"}},{"id":"b7","type":"ask","props":{"question":"Введите ваш пароль:","varname":"пароль"}},{"id":"b8","type":"condition","props":{"cond":"логин == \"admin\" && пароль == \"12345\""}},{"id":"b9","type":"message","props":{"text":"Авторизация успешна! 🚀"}},{"id":"b10","type":"stop","props":{}},{"id":"b11","type":"else","props":{}},{"id":"b12","type":"message","props":{"text":"Неправильный логин или пароль. 😔"}},{"id":"b13","type":"stop","props":{}}]}]`;
